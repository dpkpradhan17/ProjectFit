        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CoachEmail = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CoachPhone = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Admissions_Coaches_CoachId",
                        column: x => x.CoachId,
                        principalTable: "Coaches",
                        principalColumn: "CoachId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Admissions_Plans_PlanId",
                        column: x => x.PlanId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Admissions_CoachId",
                table: "Admissions",
                column: "CoachId");

            migrationBuilder.CreateIndex(
                name: "IX_Admissions_Email",
                table: "Admissions",
                column: "Email");

            migrationBuilder.CreateIndex(
                name: "IX_Admissions_PlanId",
                table: "Admissions",
                column: "PlanId");
        }
